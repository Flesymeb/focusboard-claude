...
| --- | --- | --- |
| `loop-09-ea4db9b9ae7e` | `development_snapshot:attempt-287476a390d05d43e27697d6` | NEEDS VISUAL QA |
...
- Latest candidate: `loop-09-ea4db9b9ae7e`
- Accepted candidate: `none`
- Latest attempted: `loop-09-ea4db9b9ae7e`
