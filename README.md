...
| --- | --- | --- |
| `loop-08-d5a71171daed` | `development_snapshot:attempt-492e7ceb088de6fadcf20ac8` | NEEDS VISUAL QA |
...
- Latest candidate: `loop-08-d5a71171daed`
- Accepted candidate: `none`
- Latest attempted: `loop-08-d5a71171daed`
- Latest warm start: `loop-08-8da584af31e8`
- Last published: `loop-08-d5a71171daed`
- Best verified: `loop-06-8da584af31e8`
